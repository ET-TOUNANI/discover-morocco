...
import 'package:discover_morocco/business_logic/models/models/ongoing_trip.dart';
...
import 'package:discover_morocco/views/ui/home/bookmarked/widgets/ongoing_trip.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              ...snapList
                  ...
                  .toList(),
              const Headline(text: "Bookmarked"),
              Padding(
                padding: const EdgeInsets.only(
                  top: 32.0,
                  bottom: 16,
